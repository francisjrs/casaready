...
export default function WizardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#fff9f3] to-[#f8cfa2]">
      {/* Header */}
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-brand-100 to-brand-200 border border-brand-300/50 mb-4">
              <span className="text-sm font-medium text-brand-800">{t('wizard.page.badge')}</span>
            </div>
          ...
          <div className="mt-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center px-4 py-2 text-sm text-brand-600 hover:text-brand-700 transition-colors"
              >
              ...
              <button className="inline-flex items-center px-4 py-2 text-sm text-brand-600 hover:text-brand-700 transition-colors">
                <svg className="mr-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                </svg>
                {t('wizard.liveChat')}
